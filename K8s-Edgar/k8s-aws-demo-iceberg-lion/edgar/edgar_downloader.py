#pylint:disable=c0305,c0301,c0116,c0103,c0303,w0511,r0914,w0613,w0612,r1705,w0703,E0401
'''
Created: 2020-08-03
Author : Albert Tran
...
def get_10k_artifact_links(symbol, params=None):
    ...
    headers = {'User-Agent': "kb kb@kbtherealest.com"}
...
def download_files_10k(ticker, dest_folder, year):
    '''
    Downloads 10-k files to directory.  
    cNote that directory needs to already exist.
    '''
    filing_pages  = get_10k_artifact_links(ticker, year)
